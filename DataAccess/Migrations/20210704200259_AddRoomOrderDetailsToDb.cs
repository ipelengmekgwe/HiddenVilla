    ...
    public partial class AddRoomOrderDetailsToDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomOrderDetials", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoomOrderDetials_HotelRooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomOrderDetials_RoomId",
                table: "RoomOrderDetials",
                column: "RoomId");
        }
